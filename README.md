...
```bash
pip install flask pymongo flask-cors python-dotenv requests openai
```
...
**Lucky Patel**
GitHub: https://github.com/lucky092003/AI_Assistant_BookGenie.git
